 ...
 * - Signal DB9UP: PA5 as HIGHZ    Atari joystick up
 * - Signal DB9DOWN: PA4 as HIGHZ    Atari joystick down
 * - Signal DB9LEFT: PA3 as HIGHZ    Atari joystick left
 * - Signal DB9RIGHT: PA2 as HIGHZ    Atari joystick right
 * - Signal DB9FIRE: PA1 as HIGHZ    Atari joystick fire
