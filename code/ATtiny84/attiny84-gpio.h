...
#define TOGGLE_DATA    TOGGLE_BITCLEAR_BIT(DATA_PORT, DATA_PIN)   /**< toggle GPIO pin for signal DATA */
...
#define TOGGLE_CLOCK    TOGGLE_BITCLEAR_BIT(CLOCK_PORT, CLOCK_PIN)   /**< toggle GPIO pin for signal CLOCK */
...
#define TOGGLE_LATCH    TOGGLE_BITCLEAR_BIT(LATCH_PORT, LATCH_PIN)   /**< toggle GPIO pin for signal LATCH */
...
#define TOGGLE_DB9UP    TOGGLE_BITCLEAR_BIT(DB9UP_PORT, DB9UP_PIN)   /**< toggle GPIO pin for signal DB9UP */
...
#define TOGGLE_DB9DOWN    TOGGLE_BITCLEAR_BIT(DB9DOWN_PORT, DB9DOWN_PIN)   /**< toggle GPIO pin for signal DB9DOWN */
...
#define TOGGLE_DB9LEFT    TOGGLE_BITCLEAR_BIT(DB9LEFT_PORT, DB9LEFT_PIN)   /**< toggle GPIO pin for signal DB9LEFT */
...
#define TOGGLE_DB9RIGHT    TOGGLE_BITCLEAR_BIT(DB9RIGHT_PORT, DB9RIGHT_PIN)   /**< toggle GPIO pin for signal DB9RIGHT */
...
#define TOGGLE_DB9FIRE    TOGGLE_BITCLEAR_BIT(DB9FIRE_PORT, DB9FIRE_PIN)   /**< toggle GPIO pin for signal DB9FIRE */
...
#define TOGGLE_UNUSED_A0    TOGGLE_BITCLEAR_BIT(UNUSED_A0_PORT, UNUSED_A0_PIN)   /**< toggle GPIO pin for signal UNUSED_A0 */
...
#define TOGGLE_UNUSED_B0    TOGGLE_BITCLEAR_BIT(UNUSED_B0_PORT, UNUSED_B0_PIN)   /**< toggle GPIO pin for signal UNUSED_B0 */
...
#define TOGGLE_UNUSED_B1    TOGGLE_BITCLEAR_BIT(UNUSED_B1_PORT, UNUSED_B1_PIN)   /**< toggle GPIO pin for signal UNUSED_B1 */
...
#define TOGGLE_UNUSED_B3    TOGGLE_BITCLEAR_BIT(UNUSED_B3_PORT, UNUSED_B3_PIN)   /**< toggle GPIO pin for signal UNUSED_B3 */
